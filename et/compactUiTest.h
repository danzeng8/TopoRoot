...
#ifndef COMPACTUITEST_H
#define COMPACTUITEST_H
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        sizePolicy6.setHeightForWidth(hsViewGroup->sizePolicy().hasHeightForWidth());
        hsViewGroup->setSizePolicy(sizePolicy6);
        ...
        sizePolicy7.setHeightForWidth(hideMA->sizePolicy().hasHeightForWidth());
        hideMA->setSizePolicy(sizePolicy7);
        ...
        sizePolicy7.setHeightForWidth(turnOffLightingForMABox->sizePolicy().hasHeightForWidth());
        turnOffLightingForMABox->setSizePolicy(sizePolicy7);
        ...
        sizePolicy7.setHeightForWidth(drawStPoints->sizePolicy().hasHeightForWidth());
        drawStPoints->setSizePolicy(sizePolicy7);
        ...
        sizePolicy7.setHeightForWidth(hideMALine->sizePolicy().hasHeightForWidth());
        hideMALine->setSizePolicy(sizePolicy7);
        ...
        sizePolicy7.setHeightForWidth(colorMABtn->sizePolicy().hasHeightForWidth());
        colorMABtn->setSizePolicy(sizePolicy7);
        ...
        sizePolicy8.setHeightForWidth(distVisBtnGroup->sizePolicy().hasHeightForWidth());
        distVisBtnGroup->setSizePolicy(sizePolicy8);
        ...
        sizePolicy7.setHeightForWidth(visMADistCombo->sizePolicy().hasHeightForWidth());
        visMADistCombo->setSizePolicy(sizePolicy7);
        ...
        sizePolicy7.setHeightForWidth(pruneMASlider1->sizePolicy().hasHeightForWidth());
        pruneMASlider1->setSizePolicy(sizePolicy7);
        ...
        sizePolicy7.setHeightForWidth(pruneMASpin1->sizePolicy().hasHeightForWidth());
        pruneMASpin1->setSizePolicy(sizePolicy7);
        ...
        sizePolicy7.setHeightForWidth(MATransExpSlider->sizePolicy().hasHeightForWidth());
        MATransExpSlider->setSizePolicy(sizePolicy7);
        ...
        sizePolicy7.setHeightForWidth(isoSurfSlider->sizePolicy().hasHeightForWidth());
        isoSurfSlider->setSizePolicy(sizePolicy7);
        ...
        sizePolicy7.setHeightForWidth(isoContMinAlphaSlider->sizePolicy().hasHeightForWidth());
        isoContMinAlphaSlider->setSizePolicy(sizePolicy7);
        ...
        sizePolicy7.setHeightForWidth(isoContExpAlphaSlider->sizePolicy().hasHeightForWidth());
        isoContExpAlphaSlider->setSizePolicy(sizePolicy7);
        ...
        sizePolicy8.setHeightForWidth(renderParamGroup->sizePolicy().hasHeightForWidth());
        renderParamGroup->setSizePolicy(sizePolicy8);
